...
\SetTracking{encoding=*}{30} % increase sans serif headings tracking
\titleformat{\section}{\Large\color{gray}}{}{}{}{}
...
\titleformat{\subsection}{\large\color{gray}}{}{}{}{}
...
\setlist[itemize]{label=, leftmargin=*, itemsep=\listitemspace, parsep=\listitemspace, parskip=0em}
...
\begin{tablist}
	...
	\item[2018--19]	\tab{}The City College of New York\\
	Department of English\\
...
\tabto{2em} A computational literary history arguing that the increasing centrality of statistical thinking differentiates US fiction published after the Civil War.
...
\tabto{2em} Preliminarily accepted for a special issue of \textit{MFS: Modern Fiction Studies} on "Cultural AI" edited by Richard Jean So and Aarthi Vadde.
...
\tabto{2em} Analyzes US Census Bureau statistics showing a significant decline in reading for pleasure in the US from 1982 to 2023. (Under review.)

\bigskip

\enquote{Leaving New York? Locations of US Literary Publishing Since 1945}

\smallskip

\tabto{2em} Co-authored with Luca Messarra. Using Library of Congress catalog records, this essay demonstrates that most works of American literature were only published in New York City between 1947 and 1964. The essay studies technological explanations for this counterintuitive literary historical pattern, especially the rise of offset lithography. (Under review.)
...
\tabto{2em} Identifies approximately 70,000 questions asked on \emph{Jeopardy!} that reference literature. Uses the dollar value of those questions to measure the subjective rarity of what they test.
...
\tabto{2em} Co-authored with Mark Algee-Hewitt. First large-scale analysis of about 900,000 records from \textit{The MLA International Bibliography} describing research on literatures in English.
