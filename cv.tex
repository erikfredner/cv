...
\begin{tablist}
	\item[---]\tab{}\textit{Averaging Americans: Why US Literature Started Thinking Statistically}

	\item[]\tab{}A computational literary history arguing that the increasing centrality of statistical thinking differentiates US fiction published after the Civil War. 85,000 words.
\end{tablist}
...
\begin{tablist}
	...
	\item[---]\tab{}\enquote{Anthologies at Scale} (with J.D. Porter)

	\item[]\tab{}Preliminarily accepted for \textit{Cultures of Scale: Disciplines, Data, and Labor}, edited by Joshua Ortiz Baco, Jim Casey, Benjamin Charles Germain Lee, and Sarah H. Salter. \textit{Debates in Digital Humanities}, edited by Matthew K. Gold and Lauren F. Klein. University of Minnesota Press. 6,000 words.

	\item[---]\tab{} \enquote{Moving the Capital of US Literature from Boston to New York in 11 Million Library of Congress Records}

	\item[]\tab{} Under review. Analyzes the changing geographies of US literature imprints using data from Library of Congress book records. 2,000 words.

	\item[---]\tab{}\enquote{The Ends of Reading: Reading Statistics and the Overestimation of Literary Studies' Aim}

	\item[]\tab{}Under review. Analyzes US Census Bureau statistics about reading for pleasure in the United States from 1982 to 2022. 10,000 words.

	\item[---]\tab{}\enquote{\emph{The MLA International Bibliography}'s English-Language Literary History, 1981-2023} (with Mark Algee-Hewitt)

	\item[]\tab{}First large-scale analysis of about 900,000 records from the \textit{MLAIB} describing research on literatures in English. 10,000 words.

	\item[---]\tab{}\enquote{The Literary Canon on \emph{Jeopardy!}, 1984-2023}

	\item[]\tab{}Identifies roughly 70,000 questions asked on \emph{Jeopardy!} that reference literature. Then, uses the pricing of those questions to measure the rarity of the knowledge they test. 5,000 words.
