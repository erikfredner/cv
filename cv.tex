...
\begin{tablist}
	...
	\item[]\tab{}Preliminarily accepted for \textit{Cultures of Scale: Disciplines, Data, and Labor}, edited by Joshua Ortiz Baco, Jim Casey, Benjamin Charles Germain Lee, and Sarah H. Salter. \textit{Debates in Digital Humanities}, series edited by Matthew K. Gold and Lauren F. Klein. University of Minnesota Press. 6,000 words.

	\item[·]\tab{} \enquote{Moving the Capital of US Literature from Boston to New York: Evidence from 11 Million Library of Congress Catalog Records}
	...
	\item[·]\tab{}\enquote{The Ends of Reading}
	...
	\item[]\tab{}Identifies roughly 70,000 questions asked on \emph{Jeopardy!} that reference literature. Then, uses the pricing of those questions to measure the subjective rarity of the knowledge they test. 5,000 words.
...
\emph{Recent syllabi and code available online: \href{https://fredner.org/teaching}{fredner.org/teaching}}
...
\begin{tablist}
	...
	\item[2024] \tab{}\enquote{Text Classification with Large Language Models,} The Text Analysis Pedagogy Institute
...
\begin{tablist}
	...
	\item[2024] \tab{}\enquote{\emph{The MLA International Bibliography}'s History of English-Language Literary Studies,} Alliance of Digital Humanities Organizations, George Mason University
